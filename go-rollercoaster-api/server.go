...
func (h *coasterHandlers) coasters(w http.ResponseWriter, r *http.Request) {
	...
	default:
		...
		w.Write([]byte("metod not allowed"))
		return
	}
}
...
func (a AdminPortal) handler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte("<h1>Admin Portal</h1>"))
}

func main() {
	admin := newAdminPortal()
	handler := newCoasterHandlers()

	http.HandleFunc("/coasters", handler.coasters)
	http.HandleFunc("/coasters/", handler.getCoaster)
